...
import { LEVEL_FINISHED, LEVEL_START } from "../../GameEvents";
import { Scenes } from "../../Constants";
import { CenterScreen, CenterOn, RemoveFromParent } from "@breakspace/display/Utils";

export default class SummaryScene extends GameComponent {
    ...
    constructor() {
        ...
        this.game.dispatcher.on(LEVEL_FINISHED, this.Show, this);
    }
